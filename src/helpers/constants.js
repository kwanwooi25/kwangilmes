...
export const PRODUCT_FORM_SECTIONS = [
	{
		...
		fields: [
			...
			},
			{
				type: 'radio',
				varName: 'is_print',
				options: [ { value: 'is_print_false', label: '무지' }, { value: 'is_print_true', label: '인쇄' } ],
				xs: 12,
				sm: 3,
				lg: 2
			}
	...
	},
	{
		...
		fields: [
			{ varName: 'ext_color', displayName: '압출색상', xs: 12, sm: 7, lg: 3 },
			{
				...
				options: [ { value: '단면', label: '단면' }, { value: '양면', label: '양면' } ],
				xs: 7,
				sm: 3,
				lg: 2
			},
...
export const PRODUCT_DETAIL_SECTIONS = [
	...
	{
		title: '참고사항',
		fields: [ { varName: 'unit_price', displayName: '단가' }, { varName: 'product_memo', displayName: '메모' } ]
	},
	{
		title: '작업내역',
