...
import { getOrderWeights } from '../../helpers/exportCSV';
...
class DashboardPage extends Component {
  constructor() {
    ...
    this.onStatsDownloadClick = this.onStatsDownloadClick.bind(this);
  ...
  onStatsDownloadClick() {
    const { year, month } = this.props.schedule.search;
    const token = this.props.auth.userToken;
    getOrderWeights(year, month, token);
  }
      ...
      <main>
        ...
        {value === 0 && (
          <DeliverySchedule
            ...
            onStatsDownloadClick={this.onStatsDownloadClick}
          />
        )}
        {value === 1 && (
          <OrdersNeedPlate
...
export default connect(
  mapStateToProps,
  { fetchDeliverySchedule, fetchOrdersNeedPlate, updatePlateStatus }
)(DashboardPage);
